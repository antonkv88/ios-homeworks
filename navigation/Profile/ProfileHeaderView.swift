...
class ProfileHeaderView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let imageProfile = createImage(#imageLiteral(resourceName: "hipsterDog"))
        ...
        let labelProfileName = createLabel("Brutal Dog", color : .black, fontSize : 18, textStyle : .bold)
        ...
        let labelStatus = createLabel("Waiting to something...", color : .gray, fontSize : 14, textStyle : .regular)
